...
public class ViewSelectedCourseAssessment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assessmentsEndDate = assessment.getEndDate();
        ...
        TextView viewEndDate = findViewById(R.id.assessmentFinishDate);
        ...
        viewEndDate.setText(assessmentsEndDate);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.save:
                ...
                final EditText assessmentEndDate = alertDialogViewTermSave.findViewById(R.id.assessmentDialogFinishDate);
