...
public class ViewSelectedTermCourse extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.save:
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewSelectedTermCourse.this);
